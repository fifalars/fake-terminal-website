...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome to BitBiz.be!\n" +
	    "\xa0_____ _ _\xa0\xa0 _____ _     \n" +
	    "| __\xa0 |_| |_| __ \xa0|_|___ \n" +
	    "| __ -| | \xa0_| __ -| |- _|\n" +
	    "|_____|_|_| |_____|_|___|\n" +
	    "\n" +
	    "To get started, feel free to either execute the 'help' command or use the sidenav on the left.\nIn order to skip text rolling, double click/touch anywhere.\n",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about.txt": "BitBiz provides Embedded Software Development services.",
	"contact_info.txt" : "Lars Feyaerts\nlars@bitbiz.be\n+32 (0)478 76 77 75",
        "company_info.txt": "BitBiz BV\nDorpsstraat 19\n3370, Boutersem\nBelgium\nBE0743508562\nBE96001880306705\n",
        "social_network.txt": "https://be.linkedin.com/in/larsfeyaerts"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
